...
-- CreateEnum
CREATE TYPE "PurchaseFormat" AS ENUM ('EBOOK', 'HARDCOPY');
...
CREATE TABLE "Book" (
    ...
    "hardcopyPrice" DECIMAL(10,2),
    "hardcopyStock" INTEGER NOT NULL DEFAULT 0,
    "ebookFileUrl" TEXT,
...
-- CreateIndex
CREATE UNIQUE INDEX "CartItem_cartId_bookId_format_key" ON "CartItem"("cartId", "bookId", "format");
